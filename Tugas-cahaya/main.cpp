...
void help(void) 
{ 
   printf("Model Sepeda 3D\n"); 
   printf("Kelompok 6 if 13\n"); 
   printf("Tugas Objek 3D dengan cahaya\n\n"); 
   printf("'+' untuk menambah kecepatan\n"); 
   printf("'-' untuk menurunkan kecepatan\n"); 
   printf("'b' untuk memutar Setang sepeda searah ke arah kanan\n"); 
   printf("'z' untuk memutar Setang sepeda searah ke arah kiri\n"); 
   printf("'s' or 'S' untuk mengembalikan ke tampilan dan posisi awal\n"); 
   printf("Tanda Panah untuk menggerakkan kamera\n"); 
   printf("Mouse untuk menggerakkan tampilan\n"); 
} 
